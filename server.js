...
// FIXED: Don’t subtract 1 here, that happens after the scan
if (scansUsed < limit) {
return {
hasAccess: true,
...
// FIXED: Actually use the Replicate output
// The CLIP model returns embeddings, we need to use a proper AI detector
// For now, using a better model:
...
// The AI detector returns a score between 0 and 1
